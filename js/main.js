(function () {
  ...
  var scheduleFormValidation = function () {
  ...
  var enableTogglable = function () {
    var $togglableList = $('.togglable-list');
  ...
  var enableTooltipProposals = function () {
    $('.proposals table tr').tooltip();
  };

  scheduleFormValidation();
  enableTogglable();
  enableTooltipProposals();
